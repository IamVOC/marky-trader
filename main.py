...
for i in range(3):
    download(exchange_names = ["binance"], 
            ...
            timeframe="1h", 
            dir="data",
            since=datetime.datetime(year=2020 + i, month = 1, day=1),
            until=datetime.datetime(year=2021 + i, month = 1, day=1)
    )
...
env = gym.make("MultiDatasetTradingEnv",
        ...
        positions = [-1, 0.75, -0.5, -0.25, 0, 0.25, 0.5, 0.75, 1, 2, 3], # -1 (=SHORT), 0(=OUT), +1 (=LONG)
